...
> Promise 并不指特定的某个实现，它是一种规范，是一套处理 JavaScript 异步的机制。[Promises/A+规范](http://www.ituring.com.cn/article/66566)
...
## Promise.race、Promise.all、Promise.allSettled 实现
